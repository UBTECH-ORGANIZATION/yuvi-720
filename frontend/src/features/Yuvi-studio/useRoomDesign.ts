...
export function useRoomDesign(autoLoad = true, reloadKey?: string) {
  ...
  return {
    ...
    setFloor, setWall, setMood, setSound, setGamingRoomTitle, setActiveLayout, moveStation, rotateStation, removeStation, completeTutorial, completeIntro, reset, save, load,
  }
}
