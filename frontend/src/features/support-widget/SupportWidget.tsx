...
/**
 * The live support panel.
 *
 * It is opened from the profile menu rather than from a button parked on every
 * screen - help is a thing you go and ask for, not chrome that eats the page.
...
export function SupportWidget() {
  ...
  // A closed panel renders nothing at all. When support is switched off the panel
  // still opens on request and says so, instead of a menu item that does nothing.
  ...
  return (
    <>
      ...
      {/* The only thing that may appear on its own is an answer waiting for the
          learner - otherwise there is nothing pinned to the page. */}
      ...
      {open && (
        ...
        >
          ...
          {support.phase === 'unavailable' && (
            <div className="support-widget-fallback">
