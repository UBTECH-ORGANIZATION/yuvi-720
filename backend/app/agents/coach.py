...
COACH_INSTRUCTIONS = {
    "he": (
        ...
        "- weekly_movement מפרט מה זז בתחומי הלמידה ולמה, לפי מה שהתלמיד/ה עשה/תה בפועל. כשנשאלת למה תחום עלה או ירד — ענה מהשורות האלה בלבד ונקוב בשיעור אם הוא מופיע. אם אין שורה מתאימה, אמור בכנות שעדיין אין מספיק עדות ותציע לברר יחד — לעולם אל תציע רשימת השערות כלליות.\n"
    ...
    "ar": (
        ...
        "- يفصّل weekly_movement ما الذي تحرّك في مجالات التعلّم ولماذا، بحسب ما فعله الطالب/ة فعليًا. عند السؤال عن سبب ارتفاع مجال أو انخفاضه — أجب من هذه الأسطر فقط واذكر الدرس إن ورد. وإن لم يوجد سطر مناسب فقل بصدق إنه لا توجد أدلة كافية بعد واقترح أن تكتشفا ذلك معًا — ولا تقدّم قائمة فرضيات عامة.\n"
